...
<head>
	<meta charset="utf-8" />
	<title>Add Images | Primehill</title>
						...
						<div class="col-xl-8">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="card">
										<div class="card-body">
											<h5 class="card-title mb-4">Add Images to Project</h5>
											<form class="form-inline" action="./app/models/addimage" method="post" enctype="multipart/form-data">
				                                <div class="form-group">
				                                   <input type="file" class="form-control mr-sm-3" id="file" name="file">
				                                </div>
				                                ...
				                                <div class="form-group">
				                                    <select class="form-control" name="projectID">
				                                    	...
				                                    	<?php
															$allProduct = $product->fetchProducts();
				                                    		if ($allProduct != 'null') {
				                                    			foreach (json_decode($allProduct, true) as $ac) {
				                                    				echo 
				                                    				'<option value="'. $ac['projectID'] .'">
				                                    					'. $ac['project_name'] .'
				                                    				</option>';
				                                    			}
				                                    		}
